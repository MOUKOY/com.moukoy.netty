 ...
 *
 */
final class log4j2StringStrcat extends StaticClass {
	 ...
	 */
	private static final Class<? extends MessageFactory> DEFAULT_MESSAGE_FACTORY_CLASS = createClassForProperty(
